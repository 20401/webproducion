...
namespace Agsoftware\Figma\Setup\Patch\Data;

class Parte2 implements \Magento\Framework\Setup\Patch\DataPatchInterface
{
    /**
    ...
    { 
        ...
        $block_data_head= [
            ...
            'identifier' => 'figma1',
            'is_active' => 1,
            'content' => file_get_contents(__DIR__.'/html/hablemos1.html'),
        ];
