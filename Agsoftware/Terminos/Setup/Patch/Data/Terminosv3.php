...
namespace Agsoftware\Terminos\Setup\Patch\Data;

class Terminosv4 implements \Magento\Framework\Setup\Patch\DataPatchInterface
...

 {
    ...
    { 
        ...
        $data= [
            'title' => 'Terminos & Condiciones 2',
            'identifier' => 'terminos-condiciones2',
            'is_active' => 1,
            'content' => file_get_contents(__DIR__.'/html/terminos.html'),
       ];
